...
class _DiagnosticClient:
    def __init__(self, *, rendered_status: int = 400) -> None:
...
def test_explicit_sync_isolates_rendered_description_http_400(tmp_path: Path) -> None:
...
def test_explicit_sync_does_not_probe_base_description_for_non_400(tmp_path: Path) -> None:
